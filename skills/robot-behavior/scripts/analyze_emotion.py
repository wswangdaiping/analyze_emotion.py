...
10=后退2步（向后退两步）
  适用：害怕后退、被动回避、惊吓反应
11=鞠躬谢谢（深度鞠躬，表达诚挚感谢或道歉）
  适用：感谢、道歉、表演谢幕、正式致意、比赛结束致谢
  不适用：日常打招呼、轻松场景
12=下蹲保护（身体下蹲，双手向内收拢护住身体）
  适用：害怕、受到威胁、委屈、被批评、失败后退缩、保护自己
  不适用：主动出击、正面情绪场景
13=挥手前进（一边向前走一边挥手）
  适用：开心迎接、主动靠近朋友、欢迎到来、兴奋出发
  不适用：悲伤、害怕、需要安静的场景
14=张手前进（双手张开向前伸，身体小步前移，表示欢迎或邀请）
  适用：欢迎、邀请、引导、请进、展示成果
  不适用：拒绝、害怕、紧张场景
15=鞠躬下蹲挥手前进组合（连贯完成致谢+保护+挥手前进的组合动作）
  适用：故事高潮的复杂情绪表达、表演压轴、情绪从感激转向兴奋出发
  不适用：单一情绪场景、节奏平缓的叙事段落、故事中间段
